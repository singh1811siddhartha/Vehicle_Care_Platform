...
public class AdminController {
	...
	@GetMapping("/viewservicesbymechid/{id}")
	public List<Services> getMechServices(@PathVariable Long id) {
		return serser.getServicesbyMechid(id);
	}
	...
	@GetMapping("/viewvehiclesbyuserid/{id}")
